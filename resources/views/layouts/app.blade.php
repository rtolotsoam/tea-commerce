...
<head>
    ...
    <title>@yield('title', 'Tea Commerce - Dashboard')</title>
...
<body>
    <nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
        <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6" href="{{ route('dashboard') }}">
            <i class="bi bi-cup-hot"></i> Tea Commerce
        </a>
            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="sidebar-sticky pt-3">
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('margins.*') ? 'active' : '' }}" href="{{ route('margins.index') }}">
                                <i class="bi bi-graph-up"></i> Marges
                            </a>
                        </li>
                        <li class="nav-item">
                    ...
                    <ul class="nav flex-column mb-2">
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('scraping.index') }}">
                                <i class="bi bi-robot"></i> Scraping
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('shopify.sync') }}">
                                <i class="bi bi-arrow-repeat"></i> Sync Shopify
                            </a>
                        </li>
                    </ul>
                </div>
